...
from project.deep_rl.utils.misc import Config
from project.deep_rl.utils.misc import REPO_ROOT

POLICY_ROOT = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', '..'))
...
class BaseModelMixin:
    ...
    @property
    def model_dir(self):
        return os.path.join(POLICY_ROOT, 'models', self.model_name)
